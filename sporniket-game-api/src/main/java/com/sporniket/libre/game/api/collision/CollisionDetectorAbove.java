...
/**
 * Detector that watch for anything that is strictly above an y limit.
 * 
 * <p>
 ...
 * 
 */
public class CollisionDetectorAbove extends CollisionDetectorOnBorder
{
	 ...
	 *            the y limit.
	 */
	public CollisionDetectorAbove(int border)
	{
		super(border);
	}
