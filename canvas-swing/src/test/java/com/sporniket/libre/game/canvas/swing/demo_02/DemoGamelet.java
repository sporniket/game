package com.sporniket.libre.game.canvas.swing.demo_02;
...
public class DemoGamelet extends DefaultCanvasGamelet<BufferedImage>
{
	...
	private void regenerateBackground(CanvasManager<BufferedImage> canvasManager, int cidBackground)
	{
		...
		canvasManager.setColor(Color.red);
		canvasManager.drawText(cidBackground, "aeoxu", new Point().withX(0).withY(0));
		canvasManager.drawText(cidBackground, "The lazy fox jumps etc...", new Point().withX(0).withY(32));
		canvasManager.drawFilledBox(cidBackground, new Box().withX(64).withY(64).withWidth(128).withHeight(256));
		canvasManager.setColor(Color.black);
		canvasManager.drawBox(cidBackground, new Box().withX(96).withY(96).withWidth(64).withHeight(192));
		canvasManager.setColor(new Color(0, 0, 1, 0.5f));
		canvasManager.drawFilledBox(cidBackground, new Box().withX(100).withY(100).withWidth(320).withHeight(88));
		canvasManager.enableTransparentMode();
		canvasManager.drawFilledBox(cidBackground, new Box().withX(100).withY(196).withWidth(320).withHeight(88));
		canvasManager.setColor(Color.yellow);
		canvasManager.disableTransparentMode();
		canvasManager.drawText(cidBackground, "transparency", new Point().withX(104).withY(104));
		canvasManager.drawText(cidBackground, "disabled", new Point().withX(104).withY(120));
		canvasManager.drawText(cidBackground, "transparency", new Point().withX(104).withY(200));
		canvasManager.drawText(cidBackground, "enabled", new Point().withX(104).withY(216));
