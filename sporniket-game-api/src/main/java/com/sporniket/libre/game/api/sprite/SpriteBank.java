...
public class SpriteBank implements List<Sprite>, Bank {
	...
	private List<Sprite> myContainer = new ArrayList<Sprite>(Bank.INITIAL_CAPACITY) ;

	/**
	 * @return the container
	 */
	private List<Sprite> getContainer() {
		return myContainer;
	}

	public boolean add(Sprite item) {
		return getContainer().add(item);
	}

	public void add(int index, Sprite item) {
	...
	public boolean addAll(int index, Collection<? extends Sprite> collection) {
	...
	public Sprite set(int index, Sprite item) {
	...
	public List<Sprite> subList(int start, int end) {
