...
/**
 * A sequence is a {@link List} of {@link SequenceItem}.
 * <p>
...
public class Sequence implements List<SequenceItem>, Bank {
	...
	private List<SequenceItem> myContainer = new ArrayList<SequenceItem>(Bank.INITIAL_CAPACITY) ;

	/**
	 * @return the container
	 */
	private List<SequenceItem> getContainer() {
		return myContainer;
	}

	public boolean add(SequenceItem item) {
		return getContainer().add(item);
	}

	public void add(int index, SequenceItem item) {
		getContainer().add(index, item);
	}

	public boolean addAll(Collection<? extends SequenceItem> collection) {
		return getContainer().addAll(collection);
	}

	public boolean addAll(int index, Collection<? extends SequenceItem> collection) {
	...
	public ListIterator<SequenceItem> listIterator() {
		return getContainer().listIterator();
	}

	public ListIterator<SequenceItem> listIterator(int index) {
	...
	public SequenceItem remove(int index) {
	...
	public SequenceItem set(int index, SequenceItem item) {
	...
	public List<SequenceItem> subList(int start, int end) {
