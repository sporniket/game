...
/**
 * Interface for an abstraction layer for sound playing.
 * 
 * <p>
 ...
 * 
 */
public interface SoundAbstractionLayerInterface
{
	/**
	 * Load a sound file.
	 * 
	 ...
	 * @throws IOException
	 */
	SoundHandler loadSound(String ressource) throws IOException;
	
	/**
	 * Play the specified sound.
	 * @param sound
	 */
	void playSound(SoundHandler sound);
}
