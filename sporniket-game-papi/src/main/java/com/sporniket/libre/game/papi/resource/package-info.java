/**
 * API to describe a resource and to compute the name of the underlying file, relative to the resource folder.
 * 
 * <h4>TODO</h4>
 * <ul>
 * <li>An IOC-style mechanism to setup a {@link com.sporniket.libre.game.papi.resource.ResourcePathes} implementation, if needed.</li>
 * </ul>
 * <p>
